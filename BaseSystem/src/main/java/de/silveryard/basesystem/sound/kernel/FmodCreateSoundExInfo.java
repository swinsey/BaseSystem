...
abstract class FmodCreateSoundExInfo {
    public static void enableKernel() {
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.create", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoCreate);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getlength", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetLength);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setlength", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetLength);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getfileoffset", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetFileOffset);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setfileoffset", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetFileOffset);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getnumchannels", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetNumChannels);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setnumchannels", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetNumChannels);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getdefaultfrequency", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetDefaultFrequency);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setdefaultfrequency", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetDefaultFrequency);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getformat", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetFormat);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setformat", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetFormat);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getdecodebuffersize", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetDecodeBufferSize);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setdecodebuffersize", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetDecodeBufferSize);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getinitialsubsound", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetInitialSubsound);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setinitialsubsound", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetInitialSubsound);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getnumsubsounds", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetNumSubSounds);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setnumsubsounds", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetNumSubSounds);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getinclusionlist", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetInclusionList);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setinclusionlist", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetInclusionList);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getdlsname", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetDlsName);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setdlsname", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetDlsName);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getencryptionkey", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetEncryptionKey);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setencryptionkey", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetEncryptionKey);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getmaxpolyphony", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetMaxPolyphony);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setmaxpolyphony", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetMaxPolyphony);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getsuggestedsoundtype", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetSuggestedSoundType);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setsuggestedsoundtype", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetSuggestedSoundType);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getfilebuffersize", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetFileBufferSize);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setfilebuffersize", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetFileBufferSize);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getchannelorder", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetChannelOrder);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setchannelorder", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetChannelOrder);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getchannelmask", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetChannelMask);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setchannelmask", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetChannelMask);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getinitialseekposition", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetInitialSeekPosition);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setinitialseekposition", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetInitialSeekPosition);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getseekpostype", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetInitialSeekPosType);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setseekpostype", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetInitialSeekPosType);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getignoresetfilesystem", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetIgnoreSetFilesystem);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setignoresetfilesystem", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetIgnoreSetFilesystem);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getaudioqueuepolicy", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetAudioQueuePolicy);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setaudioqueuepolicy", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetAudioQueuePolicy);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getminmidigranularity", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetMinMidiGranularity);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setminmidigranularity", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetMinMidiGranularity);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.getnonblockthreadid", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoGetNonBlockThreadId);
        Kernel.getInstance().registerSystemCall("de.silveryard.basesystem.systemcall.kernel.sound.fmodscreatesoundexinfo.setnonblockthreadid", FmodCreateSoundExInfo::systemCallSoundFmodCreateSoundExInfoSetNonBlockThreadId);
    }
