...
#include "de_awesome_smarthome_td_sound_FmodSystem.h"
#include <iostream>
...
namespace {
	...
	void _init(JNIEnv* env) {
		...
		_class = env->FindClass("de/awesome/smarthome/td/sound/FmodSystem");
...
(JNIEnv* env, jobject obj, jstring nameOrData, jint mode, jobject exInfo, jobject sound) {
	...
	if (exInfo != NULL) {
		long infoPtr = Java_de_awesome_smarthome_td_sound_FmodCreateSoundExInfo_getHandle(env, exInfo);
	...
	Java_de_awesome_smarthome_td_sound_FmodSound_setHandle(env, sound, reinterpret_cast<long>(native_sound));
...
(JNIEnv* env, jobject obj, jobject sound, jboolean paused, jobject channel) {
	...
	FMOD::System* system = get_handle<FMOD::System>(env, _field_handle, obj);
	jlong soundHandle = Java_de_awesome_smarthome_td_sound_FmodSound_getHandle(env, sound);
	...
	Java_de_awesome_smarthome_td_sound_FmodChannel_setHandle(env, channel, reinterpret_cast<long>(native_channel));
...
(JNIEnv* env, jobject obj, jint id, jobject sound, jboolean loop) {
	...
	FMOD::System* system = get_handle<FMOD::System>(env, _field_handle, obj);
	long soundPtr = Java_de_awesome_smarthome_td_sound_FmodSound_getHandle(env, sound);
