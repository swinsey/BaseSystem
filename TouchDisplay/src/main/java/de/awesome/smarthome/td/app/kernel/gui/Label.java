...
import de.awesome.smarthome.td.gui.Font;
import de.awesome.smarthome.td.gui.*;
    ...
    private static QAMessage systemCallLabelCreate(RunningApp app, QAMessage message){
        ...
        graphicsManager.runNextFrame(new Action() {
            ...
            public void invoke() {
                ...
                de.awesome.smarthome.td.gui.Font font = Utils.as(Font.class, obj);
                if(font == null){
                    returnCode.value = ReturnCode.ERROR;
                ...
                de.awesome.smarthome.td.gui.Label label = frame.createLabel(
                        font, text,
    ...
    private static QAMessage systemCalLabelGetFont(RunningApp app, QAMessage message){
        ...
        GraphicsManager.getInstance().runNextFrame(new Action() {
            ...
            public void invoke() {
                ...
                de.awesome.smarthome.td.gui.Label label = Utils.as(de.awesome.smarthome.td.gui.Label.class, obj);
    ...
    private static QAMessage systemCallLabelSetFont(RunningApp app, QAMessage message){
        ...
        GraphicsManager.getInstance().runNextFrame(new Action() {
            ...
            public void invoke() {
                ...
                de.awesome.smarthome.td.gui.Label label = Utils.as(de.awesome.smarthome.td.gui.Label.class, objLabel);
                Font font = Utils.as(Font.class, objFont);
