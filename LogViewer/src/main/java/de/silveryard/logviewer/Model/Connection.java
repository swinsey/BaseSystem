...
import de.silveryard.logviewer.Utility.Util;
...
public abstract class Connection {
    ...
    private static Map<String, IActionP1<Message>> messageHandlers;
    ...
    public static void registerMessageHandler(String command, IActionP1<Message> handler){
        messageHandlers.put(Util.generateMd5(command), handler);
    }
    ...
    public static void sendMessage(String command, List<Parameter> params){
        Message message = new Message(uuid, SERVER_UUID, Util.generateMd5(command), params);
        transport.send(message);
    }
    /*public static QAMessage sendQaMessage(String command, List<Parameter> params){
        return sendQaMessage(command, params, null);
    }
    public static QAMessage sendQaMessage(String command, List<Parameter> params, byte[] data){
    ...
    */
    private static void handleMessage(Message message){
        ...
        IActionP1<Message> handler = messageHandlers.get(message.getCommandHash());
        if(handler != null){
