...
public class SystemVolume {
     ...
     * @param outMute Mute flag value
     */
    public static void systemCallSoundSystemVolumeGetInputMute(
            Wrapper<ReturnCode> outReturnCode, Wrapper<SoundReturnCode> outSoundReturnCode,
            Wrapper<Boolean> outMute
    ){

        List<Parameter> params = new ArrayList<>();
        QAMessage response = Kernel.systemCall("de.silveryard.basesystem.systemcall.sound.systemvolume.getinputmute", params);
     ...
     * @param outSoundReturnCode Sound Return Code
     */
    public static void systemCallSoundSystemVolumeSetInputMute(
            boolean mute,
            Wrapper<ReturnCode> outReturnCode, Wrapper<SoundReturnCode> outSoundReturnCode
    ){
        ...
        List<Parameter> params = new ArrayList<>();
        params.add(Parameter.createBoolean(mute));
        QAMessage response = Kernel.systemCall("de.silveryard.basesystem.systemcall.sound.systemvolume.setinputmute", params);
     ...
     * @param outVolume Master volume value
     */
    public static void systemCallSoundSystemVolumeGetInputMasterVolume(
            Wrapper<ReturnCode> outReturnCode, Wrapper<SoundReturnCode> outSoundReturnCode,
            Wrapper<Float> outVolume
    ){

        List<Parameter> params = new ArrayList<>();
        QAMessage response = Kernel.systemCall("de.silveryard.basesystem.systemcall.sound.systemvolume.getinputmastervolume", params);
     ...
     * @param outSoundReturnCode Sound Return Code
     */
    public static void systemCallSoundSystemVolumeSetInputMasterVolume(
            float volume, Wrapper<ReturnCode> outReturnCode,
            Wrapper<SoundReturnCode> outSoundReturnCode
    ){
        ...
        List<Parameter> params = new ArrayList<>();
        params.add(Parameter.createFloat(volume));
        QAMessage response = Kernel.systemCall("de.silveryard.basesystem.systemcall.sound.systemvolume.setinputmastervolume", params);
     ...
     * @param outNumChannels Number of channels
     */
    public static void systemCallSoundSystemVolumeGetNumInputChannels(
            Wrapper<ReturnCode> outReturnCode, Wrapper<SoundReturnCode> outSoundReturnCode,
            Wrapper<Integer> outNumChannels
    ){

        List<Parameter> params = new ArrayList<>();
        QAMessage response = Kernel.systemCall("de.silveryard.basesystem.systemcall.sound.systemvolume.getnuminputchannels", params);
     ...
     * @param outType Channel type
     */
    public static void systemCallSoundSystemVolumeGetInputChannelType(
            int index,
            Wrapper<ReturnCode> outReturnCode, Wrapper<SoundReturnCode> outSoundReturnCode,
            Wrapper<SystemVolumeChannelType> outType
    ){
        ...
        List<Parameter> params = new ArrayList<>();
        params.add(Parameter.createInt(index));
        QAMessage response = Kernel.systemCall("de.silveryard.basesystem.systemcall.sound.systemvolume.getinputchanneltype", params);
     ...
     * @param outVolume Volume value
     */
    public static void systemCallSoundSystemVolumeGetInputChannelVolume(
            int index,
            Wrapper<ReturnCode> outReturnCode, Wrapper<SoundReturnCode> outSoundReturnCode,
            Wrapper<Float> outVolume
    ){
        ...
        List<Parameter> params = new ArrayList<>();
        params.add(Parameter.createInt(index));
        QAMessage response = Kernel.systemCall("de.silveryard.basesystem.systemcall.sound.systemvolume.getinputchannelvolume", params);
     ...
     * @param outSoundReturnCode Sound Return Code
     */
    public static void systemCallSoundSystemVolumeSetInputChannelVolume(
            int index, float volume,
            Wrapper<ReturnCode> outReturnCode, Wrapper<SoundReturnCode> outSoundReturnCode
    ){
        ...
        params.add(Parameter.createInt(index));
        params.add(Parameter.createFloat(volume));
        QAMessage response = Kernel.systemCall("de.silveryard.basesystem.systemcall.sound.systemvolume.setinputchannelvolume", params);
